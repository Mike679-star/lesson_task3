...
def main(args):
    ...
    img1 = Image.open(args.groundtruth_path)
    img.show()
    out_img = t.run(img)
    out_img.show()
    out_img.save(args.result_path)
    print(t.calculate_psnr(F.to_tensor(img1), F.to_tensor(out_img)))
...
if __name__ == '__main__':
    ...
    parse.add_argument("--groundtruth_path", default=r"./groundtruth.jpg", type=str)
